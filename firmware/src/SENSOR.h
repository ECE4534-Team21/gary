...
//GREEN - PIN 4
//BLUE - PIN 6
#define LINE_SENSOR_RIGHT_PORT PORT_CHANNEL_D //ORANGE - CHIPKIT #9 - SENSOR #2
#define LINE_SENSOR_MIDDLE_PORT PORT_CHANNEL_A //GREEN CHIPKIT #12 - SENSOR #4
#define LINE_SENSOR_LEFT_PORT PORT_CHANNEL_D //BLUE- CHIPKIT #10 SENSOR #6
    
#define LINE_SENSOR_RIGHT_BIT PORTS_BIT_POS_3
...
#define TOGGLE_LED4 PLIB_PORTS_PinToggle(PORTS_ID_0, LED4_PORT, LED4_BIT);
...
#define CLEAR_LED5 PLIB_PORTS_PinClear(PORTS_ID_0, LED5_PORT, LED5_BIT);
 #define TOGGLE_LED5 PLIB_PORTS_PinToggle(PORTS_ID_0, LED5_PORT, LED5_BIT);
