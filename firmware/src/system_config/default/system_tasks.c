...
static void _OLED_Tasks(void);
static void _ROVER_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for OLED Tasks. */
    xTaskCreate((TaskFunction_t) _OLED_Tasks,
                "OLED Tasks",
                1024, NULL, 1, NULL);

    /* Create OS Thread for ROVER Tasks. */
    xTaskCreate((TaskFunction_t) _ROVER_Tasks,
                "ROVER Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _USART_Tasks ( void )

  Summary:
    Maintains state machine of USART.
*/
...
/*******************************************************************************
  Function:
    void _OLED_Tasks ( void )

  Summary:
    Maintains state machine of OLED.
*/
...
/*******************************************************************************
  Function:
    void _ROVER_Tasks ( void )

  Summary:
    Maintains state machine of ROVER.
*/
